...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrive_it_later(self):
        ...
        # She notices the page title and a header mention to-do lists
        ...
        # is trying to fly-fishing lures)
        ...
        # Edith wonders either the site will remember the list. Then she sees
